...
using CleanArchitecture.Blazor.$safeprojectname$.Features.AuditTrails.DTOs;

namespace CleanArchitecture.Blazor.$safeprojectname$.Features.AuditTrails.Queries.PaginationQuery;
