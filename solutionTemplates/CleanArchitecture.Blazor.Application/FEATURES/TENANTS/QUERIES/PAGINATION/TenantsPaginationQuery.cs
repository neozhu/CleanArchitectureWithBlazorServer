...
using CleanArchitecture.Blazor.$safeprojectname$.Features.Tenants.Caching;

namespace CleanArchitecture.Blazor.$safeprojectname$.Features.Tenants.Queries.Pagination;
