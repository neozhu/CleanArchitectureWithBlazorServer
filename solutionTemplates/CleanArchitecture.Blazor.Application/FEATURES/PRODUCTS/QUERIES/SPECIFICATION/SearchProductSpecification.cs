using CleanArchitecture.Blazor.$safeprojectname$.Features.Products.Queries.Pagination;

namespace CleanArchitecture.Blazor.$safeprojectname$.Features.Products.Queries.Specification;
