...
//     Description: 
//       Handles the `SupplierCreatedEvent` which occurs when a new supplier is created.
...
public class SupplierCreatedEventHandler : INotificationHandler<SupplierCreatedEvent>
{
        ...
        public SupplierCreatedEventHandler(
            ILogger<SupplierCreatedEventHandler> logger
            )
        {
            _logger = logger;
        }
