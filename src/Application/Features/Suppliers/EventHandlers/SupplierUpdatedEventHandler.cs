...
//     Description: 
//       Handles the `SupplierUpdatedEvent` which occurs when a new supplier is updated.
...
namespace CleanArchitecture.Blazor.Application.Features.Suppliers.EventHandlers;
    ...
    public class SupplierUpdatedEventHandler : INotificationHandler<SupplierUpdatedEvent>
    {
        ...
        public SupplierUpdatedEventHandler(
            ILogger<SupplierUpdatedEventHandler> logger
            )
        {
            _logger = logger;
        }
